...
base_price = st.number_input("기준가격", value=820000000, format="%d")
...
option = st.text_input(remove_parentheses("옵션구성(금액, 비우면 제외)"), value="")
extra = st.text_input(remove_parentheses("추가인정금액(비우면 0)"), value="")

weights = {0:0, 1:0.0012, 2:0.002, 3:0.0035, -1:-0.0012, -2:-0.002, -3:-0.0035}
